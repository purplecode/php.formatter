...
class PHP_Beautifier implements PHP_Beautifier_Interface {
    ...
    */
    private function resetProperties() {
        $aProperties = array('aTokens' => array(), 'aOut' => array(), 'aModes' => array(), 'iCount' => 0, 'iIndent' => 0/*$this->iIndentNumber*/, 'aIndentStack' => array(/*$this->iIndentNumber*/ ), 'iArray' => 0, 'iParenthesis' => 0, 'currentWhitespace' => '', 'aAssocs' => array(), 'iControlLast' => null, 'aControlSeq' => array(), 'bBeautify' => true);
    ...
    */
    private function controlToken($aCurrentToken) {
        ...
        ($aCurrentToken[0]) {
            ...
            break;
            case'{' : if($this->isPreviousTokenConstant(T_VARIABLE) or ($this->isPreviousTokenConstant(T_STRING) and $this->getPreviousTokenConstant(2) == T_OBJECT_OPERATOR) or $this->isPreviousTokenConstant(T_OBJECT_OPERATOR)) {
